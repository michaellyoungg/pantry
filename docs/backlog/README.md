...
| [BL-0046](BL-0046-kroger-real-store-prices.md) | Real store prices (opt-in) — Kroger Products API behind a feature flag | done | pricing | M |
...
| [BL-0063](BL-0063-native-recipes-browse.md) | Native recipes browse (list, catalog, kitchen, filters, add funnel) | done | mobile | L |
| [BL-0064](BL-0064-native-week-planner.md) | Native week planner | done | mobile | L |
| [BL-0065](BL-0065-native-nutrition-surfaces.md) | Native nutrition surfaces (facts panel, goals, plan rollup, recipe fit) | in-progress | mobile | L |
| [BL-0066](BL-0066-native-settings-preferences.md) | Native settings and preferences (taste, avoid list, equipment, household) | in-progress | mobile | M |
...
| [BL-0073](BL-0073-nightly-mobile-e2e.md) | Nightly mobile e2e — flow parity with the browser suite | in-progress | mobile | L |
