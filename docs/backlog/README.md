...
| [BL-0016](BL-0016-app-ia-responsive-nav.md) | App IA + responsive navigation shell (5 routes, sidebar ↔ bottom tabs) | proposed | web | M |
| [BL-0017](BL-0017-home-dashboard-weekly-handoff.md) | Home dashboard — state-aware next action + shopping-day handoff | proposed | web | M |
| [BL-0018](BL-0018-meal-planner-week.md) | Meal planner — basket becomes a dinner-first week plan | proposed | meal-planning | L |
