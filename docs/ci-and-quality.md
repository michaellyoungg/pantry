...
| Job | Steps |
| --- | --- |
| **Node** | Biome (lint + format + import order) · backlog index freshness · TypeScript typecheck · Vitest with coverage (incl. design-token drift guard) · build · Knip (dead code / unused deps) |
